...
GlobalLimitExec: skip=0, fetch=100
  BoundedWindowAggExec: wdw=[row_number: Field { name: "row_number", data_type: UInt64, nullable: false, dict_id: 0, dict_is_ordered: false, metadata: {} }, frame: ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW], mode=[Sorted]
